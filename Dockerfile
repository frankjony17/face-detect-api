...
LABEL \
    ...
    br.com.fk.image.app.maintainer="FkSolutions / DITEC <frankjony17@gmail.com>" \
    br.com.fk.image.app.version="$VERSAO" \
    br.com.fk.image.description="" \
    org.label-schema.maintainer="FkSolutions / DITEC <frankjony17@gmail.com>" \
    org.label-schema.vendor="FkSolutions" \
    org.label-schema.url="https://github.com/frankjony17/face-detect-api" \
    org.label-schema.name="" \
    org.label-schema.license="COPYRIGHT" \
    org.label-schema.version="$VERSAO" \
    org.label-schema.vcs-url="https://github.com/frankjony17/face-detect-api" \
...
WORKDIR /usr/src/app/face_detect/
# Run gunicorn
